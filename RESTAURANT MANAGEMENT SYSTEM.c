...
void admin()
{
    ...
    if(user=="restaurant"||passwd==12345)
    {
...
int main()
{
    ...
    heada = createadmin(heada,2,"Chicken soup",200);
    heada = createadmin(heada,3,"Chicken Noodles",150);
    heada = createadmin(heada,4,"Fried Rice",180);
    heada = createadmin(heada,5,"Shawarma",80);
